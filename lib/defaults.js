...
const zero2 = /** @type {types.Point} */ ([0, 0]);
const x2 = /** @type {types.Point} */ ([1, 0]);
const y2 = /** @type {types.Point} */ ([0, 1]);
const nx2 = /** @type {types.Point} */ ([-1, 0]);
const ny2 = /** @type {types.Point} */ ([0, -1]);

export { zero3, x3, y3, z3, nx3, ny3, nz3, zero2, x2, y2, nx2, ny2 };
