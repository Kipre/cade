...
export class TenonMortise extends NoSegmentIndexBaseSlot {
  /**
   * @param {number} x
   */
  constructor(
...
export class ThroughAngleSupport extends NoSegmentIndexBaseSlot {
  /**
...
export class GenericThroughAngleSupport extends NoSegmentIndexBaseSlot {
  /**
